    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, bcrypt_1.default.hash(req.body.password, 10)];
            case 3:
                hashedPwd = _a.sent();
                user_1 = new userModel_1.default(__assign(__assign({}, req.body), { password: hashedPwd }));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                verify = _a.sent();
                if (verify) {
                    token = jsonwebtoken_1.default.sign(user.toJSON(), process.env.ACCESS_TOKEN_SECRET);
                    res.status(200).send({
                        token: token,
                    });
                }
